...
function resetTextBox()
{
  ...
  options.resultsContainer.parentNode.style.display = "none";
...
document.getElementById("reset")
  ...
  function appendToResultsContainer (text) {
    ...
    {
      text = text.replace("<div class=\"search-img", "<div class=\"search-no-img")
      text = text.replace(/<img.*?"{image}">/g, "")
    }
  ...
  function registerInput () {
    options.searchInput.addEventListener('input', function (e) {
      if (isWhitelistedKey(e.which)) {
        ...
        if(e.target.value != '')
        {
          options.resultsContainer.parentNode.style.display = "";
        }
        else
        {
          options.resultsContainer.parentNode.style.display = "none";
